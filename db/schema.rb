...
ActiveRecord::Schema[8.0].define(version: 2025_06_11_192536) do
  ...
  create_table "asteroid_positions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["birth_chart_id", "name"], name: "index_asteroid_positions_on_birth_chart_id_and_name", unique: true
    t.index ["birth_chart_id"], name: "index_asteroid_positions_on_birth_chart_id"
  end
  ...
  add_foreign_key "asteroid_positions", "birth_charts"
